...
- `run_InterfaceGanga.py`
    ...
    Creates an `InterfaceGanga` object to generate code for the challenge task using the LLM and store them as scripts in the `gangagsoc` directory.
...
In the ganga prompt, first go to the `gangagsoc` directory which should be at the same level as the GSoC directory.
...
```
Extracted pages from LHC.pdf have been saved in the folder /path_to_this_git_repo/GangaGSoC2024/gangagsoc/extracted_pages
...
```
Extracted page 1 from /path_to_this_git_repo/GangaGSoC2024/gangagsoc/LHC.pdf and saved as /path_to_this_git_repo/GangaGSoC2024/gangagsoc/extracted_pages/LHC_page_1.pdf
```
...
The word count has been stored in the same directory as this script: /path_to_this_git_repo/GangaGSoC2024/gangagsoc/count_it.txt

Run this command to see the stored result: cat /path_to_this_git_repo/GangaGSoC2024/gangagsoc/count_it.txt
