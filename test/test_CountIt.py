...
class TestCountIt(unittest.TestCase):
    def testGetArguments(self):
        ...
        self.assertEqual(get_arguments(), ("current_dir", "page_num", "word", "pdf_file"))
    ...
    def testPreprocessText(self):
        ...
        self.assertEqual(preprocess_text(text), "the large hadron collider  citation  cern more text")
    ...
    def testCountWord(self):
        ...
        self.assertEqual(count_word(pdf_file, "0", "hadron"), 1)
        os.remove(pdf_file)
